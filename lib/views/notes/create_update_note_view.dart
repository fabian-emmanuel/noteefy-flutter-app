...
import 'package:noteefy/utilities/dialogs/cannot_share_empty_note_dialog.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  void _textControllerListener() async {
    ...
    await _noteService.updateNote(text: text, documentId: note.documentId);
  }
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    ...
    final newNote = await _noteService.createNewNote(ownerUserId: currentUser.id);
    _note = newNote;
    return newNote;
  }
            ...
            case ConnectionState.done:
              ...
              return Padding(
                ...
                child: TextField(
                  ...
                  maxLines: null,
                  decoration: InputDecoration(hintText: context.loc.start_typing_your_note),
                ),
              );
            default:
